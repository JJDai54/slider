...
// ---------------- Admin Others ----------------
\define('_AM_SLIDER_SLIDE_ALWAYS_VISIBLE', 'Always actif');
\define('_AM_SLIDER_SLIDE_ALWAYS_VISIBLE_DESC', 'Visible regardless of the defined period and if "actif" is true');
